...
use_ok('VericredClient::DrugPackagesApi');

my $api = VericredClient::DrugPackagesApi->new();
isa_ok($api, 'VericredClient::DrugPackagesApi');

#
# show_formulary_drug_package_coverage test
#
{
    my $formulary_id = undef; # replace NULL with a proper value
    my $ndc_package_code = undef; # replace NULL with a proper value
    my $result = $api->show_formulary_drug_package_coverage(formulary_id => $formulary_id, ndc_package_code => $ndc_package_code);
}
