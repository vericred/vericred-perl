...
use_ok('VericredClient::ZipCountiesApi');

my $api = VericredClient::ZipCountiesApi->new();
isa_ok($api, 'VericredClient::ZipCountiesApi');

#
# get_zip_counties test
#
{
...
#
# show_zip_county test
#
{
    my $id = undef; # replace NULL with a proper value
    my $result = $api->show_zip_county(id => $id);
}
