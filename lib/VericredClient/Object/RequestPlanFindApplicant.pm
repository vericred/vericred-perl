...
#
package VericredClient::Object::RequestPlanFindApplicant;
...
__PACKAGE__->method_documentation({
    'age' => {
    	datatype => 'int',
    	base_name => 'age',
    	description => 'Age of applicant to search for',
    	format => '',
    	read_only => '',
    		},
    'child' => {
    	datatype => 'boolean',
    	base_name => 'child',
    	description => 'Is this applicant a child?',
    	format => '',
    	read_only => '',
    		},
    'smoker' => {
    	datatype => 'boolean',
    	base_name => 'smoker',
    	description => 'Does this applicant smoke?',
    	format => '',
    	read_only => '',
    		},
});
