...
#
package VericredClient::Object::PlanSearchResponseMeta;
...
__PACKAGE__->method_documentation({
    ...
    'eligible_for_chip_medicaid' => {
    	datatype => 'boolean',
    	base_name => 'eligible_for_chip_medicaid',
    	description => 'Is this applicant potentially eligible for Chip or Medicaid?',
    	format => '',
    	read_only => '',
    		},
});
